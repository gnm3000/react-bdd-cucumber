        ...
        <div className="container flex flex-col gap-4 py-6 lg:flex-row lg:items-center lg:justify-between">
          <div className="space-y-2">
            ...
            <div>
              ...
              <p className="text-sm text-slate-500">
                Layout con grid, container y paleta azul, blanco y gris.
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-col gap-3 lg:items-end">
            ...
            <div className="flex flex-wrap gap-2 text-xs text-slate-500">
              ...
              <span className="rounded-full bg-slate-100 px-3 py-1">Orders: {ordersCount}</span>
            </div>
          </div>
        </div>
      </header>
          ...
          <aside className="h-fit rounded-3xl border border-slate-200 bg-white p-6 shadow-soft">
            ...
            <div className="mt-4 grid gap-4">
              ...
              <div className="rounded-2xl border border-dashed border-slate-300 p-4 text-sm text-slate-500">
                Flujo simple para pruebas BDD: catalogo, carrito, checkout y ordenes.
              </div>
            </div>
          </aside>
        </div>
